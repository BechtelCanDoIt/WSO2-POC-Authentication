...
-- GRANT ALL PRIVILEGES ON WSO2CARBON_DB.* TO 'WSO2CARBON'@'%';

-- Apply changes
FLUSH PRIVILEGES;

-- WSO2IDENTITY_DB DATABASE --------------------------------------------------------------------------------------
use WSO2IDENTITY_DB;
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH_CONSUMER_APPS (
            ...
            CONSUMER_SECRET VARCHAR(768),
            USERNAME VARCHAR(255),
            TENANT_ID INTEGER DEFAULT 0,
            USER_DOMAIN VARCHAR(50),
            APP_NAME VARCHAR(255),
            OAUTH_VERSION VARCHAR(128),
            CALLBACK_URL VARCHAR(768),
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN (
            ...
            ACCESS_TOKEN VARCHAR(768),
            REFRESH_TOKEN VARCHAR(768),
            CONSUMER_KEY_ID INTEGER,
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_AUTHORIZATION_CODE (
            CODE_ID VARCHAR (255),
            AUTHORIZATION_CODE VARCHAR(768),
            CONSUMER_KEY_ID INTEGER,
            CALLBACK_URL VARCHAR(768),
            SCOPE VARCHAR(768),
            AUTHZ_USER VARCHAR (100),
...
CREATE TABLE IF NOT EXISTS FIDO_DEVICE_STORE (
            ...
            DEVICE_DATA VARCHAR(768) NOT NULL,
...
CREATE TABLE CM_RECEIPT (
  ...
  PII_CONTROLLER      VARCHAR(768) NOT NULL,
...
CREATE TABLE IF NOT EXISTS AM_SERVICE_CATALOG (
            ...
            TENANT_ID INTEGER NOT NULL,
            SERVICE_URL VARCHAR(768) NOT NULL,
            DEFINITION_TYPE VARCHAR(20),
            DEFINITION_URL VARCHAR(768),
            DESCRIPTION VARCHAR(1024),

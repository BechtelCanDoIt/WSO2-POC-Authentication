-- add users
FLUSH PRIVILEGES;
GRANT ALL PRIVILEGES ON *.* TO 'root'@'%' IDENTIFIED BY 'ROOT_PASSWORD123' WITH GRANT OPTION;
FLUSH PRIVILEGES;

ALTER USER 'WSO2CARBON'@'%' IDENTIFIED BY 'WSO2CARBON_PASSWORD123';
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT ON *.* TO 'WSO2CARBON'@'%' IDENTIFIED BY 'WSO2CARBON_PASSWORD123';
...
/* see if wso2 will auto create required tables
-- WSO2 AM tables
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS REG_ASSOCIATION (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS REG_SNAPSHOT (
